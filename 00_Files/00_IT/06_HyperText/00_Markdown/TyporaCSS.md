...
:root {
    ...
    --side-bar-bg-color: #eeeeee; /*左边栏background*/
    --control-text-color: #000; /*左边栏文本color*/
	
	--bg-color: #eaeaea; /*右边栏background*/
	
	--control-text-color: #000; /*左窗口文本色*/
    --control-bg-hover-color: #f00; /*左窗口悬停项的文本色*/
...
.md-toc-h2 .md-toc-inner { margin-left: 10px; border-left-color: #FF7F50; }
.md-toc-h3 .md-toc-inner { margin-left: 20px;; border-left-color: #ff0; }
.md-toc-h4 .md-toc-inner { margin-left: 30px;; border-left-color: #0f0; }
.md-toc-h5 .md-toc-inner { margin-left: 40px;; border-left-color: #97ffff; }
.md-toc-h6 .md-toc-inner { margin-left: 60px;; border-left-width: 0px; }
